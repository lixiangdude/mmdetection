...
split = 'val'
data_path = '/home/lixiang/下载/模型训练/data'
...
#这里设置.txt文件保存位置
parser.add_argument('--save_path', default=f'{data_path}/labels/{split}', type=str, help="specify where to save the output dir of labels")
